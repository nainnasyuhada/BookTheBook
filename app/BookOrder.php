...
class BookOrder extends Model
{
    ...
    protected $fillable = [
        'user_id', 'category_id', 'subject_id', 'title', 'author', 'publisher', 'year', 'isbn', 'coverPage', 'price', 'status_id', 'bookSell_id', 'buyer_id'
    ];
    ...
    // Creating relationship - BookSell belongs to a buyer
